...
public class PayrollCalculator {
 ...
 public double calculateGross(Employee emp) {
    // Business Rule: Gross = Monthly Basic + Total Allowances
    return emp.getBasicSalary() + calculateTotalAllowances(emp);
}
...
public double calculateTotalAllowances(Employee emp) {
    if (emp == null) return 0.0;
    // Sum the individual attributes mapped by the DAO
