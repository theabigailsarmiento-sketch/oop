...
public Object[] getEmployeeDetailsForForm(int empId) {
    ...
    return new Object[] {
        e.getEmpNo(), e.getLastName(), e.getFirstName(), e.getBirthday(),
        e.getAddress(), e.getPhone(), e.getSss(), e.getPhilhealth(),
        e.getTin(), e.getPagibig(), e.getStatus(), e.getPosition(),
        e.getSupervisor(), e.getBasicSalary(), e.getRiceSubsidy(),
        e.getPhoneAllowance(), e.getClothingAllowance(), 
        e.getGrossSemiMonthlyRate(), e.getHourlyRate(), e.getRole()
    };
}
}